...
##Boss Time Values:
  ...
  ## Battle Timer Fix
    ...
    elif timeUntilNextBattleInMinutes > -120  and timeUntilNextBattleInMinutes < -60:
    ...
    elif timeUntilNextBattleInMinutes > -180 and timeUntilNextBattleInMinutes < -120:
    ...
    elif timeUntilNextBattleInMinutes > -120 and timeUntilNextBattleInMinutes < -180:
